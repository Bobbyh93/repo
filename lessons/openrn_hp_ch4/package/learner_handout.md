...
structure → dynamics → risk → strain → action

### Opening case: an 8-year-old with abdominal pain
- Living situation and household
- How family members interact
- What the child believes about the divorce
- Strengths, stressors, supports

**Try it:** List three things you still need to know before you can plan care.


### The organizing question

### Chapter map: structure to action

### Structure: who is family, and what does a family do?
...
### Structure: roles, culture, and the nurse's own bias
...
### Risk: adverse childhood experiences are dose-dependent
...
### Risk: protective factors the nurse can build
...
**Try it:** Write two sentences of anticipatory guidance for the divorcing parents in the opening case.


### Risk: four parenting styles on two axes
...
### Risk: what positive discipline looks like
...
### Strain: one member's illness reaches the whole family
...
### Strain: caregiver role strain and what the nurse offers
...
### Action: sort the cues by what the nurse does next

**Try it:** Order the four cues from most to least urgent nursing action.


### Checkpoint: the caregiver in the waiting room

**Try it:** Select one.


### Capstone: the abdominal pain case, resolved
- Pain assessment complete; provider notified
- Then the family history produces a new cue

**Try it:** Select one.


### Rapid retrieval: five-item exit check
...
**Try it:** Answer all five.


### Takeaway: what the nurse notices, and what the nurse does first
- Notice: roles, functions, interaction, strain
- Sort: report, refer, resource, teach
- Protect: privacy first, client's voice first
- Teach: guidance, not punishment

## Exit check

For each concept lane, write one thing the nurse should *notice*, and one thing the nurse should *do*.


## Attribution

- Adapted from Open RN, Nursing Health Promotion, Chapter 4 (Ernstmeyer & Christman, eds., 2025), CC BY 4.0. https://wtcs.pressbooks.pub/healthpromo/