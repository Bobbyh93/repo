...
| WP-6 second lesson (NCLEX sepsis recognition, author's own SRC02) | done, review-needed — `lessons/nclex_sepsis_recognition/` (hand-written) |
| WP-7 remaining seven NCLEX exemplar topics | done, review-needed — generated by `lessons/build_from_topic.py` from `handoff/source/nclex_rn_2026_topics.json` |
